...

{
    ...
    ["life_inv_corona",life_inv_corona],
    ["life_inv_landshark",life_inv_landshark],
    ["life_inv_coorslights",life_inv_coorslights],
    ["life_inv_budweiser",life_inv_budweiser],
    ...
    ["life_inv_cellphone",life_inv_cellphone],
    ...
    ["life_inv_storage2",life_inv_storage2],
    ["life_inv_storage2",life_inv_storage2],
