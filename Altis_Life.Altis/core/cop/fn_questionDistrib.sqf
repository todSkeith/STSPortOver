...
_names = "";
{
	...
	[[_x select 0,_x select 1,"484",_val],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
	_names = _names + format["%1<br/>",_x select 1];
} foreach _sellers;

hint parseText format["The following people have been selling to this distributor recently.<br/><br/>%1",_names];
